    ...
    return(
        ...
        <>
                ...
                <div className={styles['alternate-address']} >
                    ...
                    <input id="altFirstname"
                           {...register("altFirstnameCustomer",
                    ...
                    <input id="altLastname"
                           {...register("altLastnameCustomer",
                               {required: {value: true, message: message }})} />
