    ...
    return (
        ...
        <>
            ...
            <div className={styles['machine-wrapper']} >
                ...
                <ul
                    className={styles['machine-images']} >

                    <div
                        className={styles['machine1']} >
